...
export const aboutUsCards = [
  {
    ...
    para: "Every blockchain product I develop showcases my passion for decentralization, performance optimization, and future-focused innovation.",
    animationOrder: 4,
    active: true,
  },
  {
    ...
    para: "Every AI workflow I design combines technical excellence with measurable value, showing my dedication to building intelligent and adaptive solutions.",
    animationOrder: 5,
  },
  {
    iconClass: "fa-light fa-palette",
    title: "Web Development",
    para: "Every website I create blends performance, accessibility, and intuitive design, ensuring meaningful results for users and businesses.",
    animationOrder: 5,
  },
  {
    iconClass: "fa-light fa-print",
    title: "Project Marketing",
    para: "Every campaign I launch combines strategic planning with creative execution, proving my ability to deliver meaningful results.",
    animationOrder: 4,
  },  
];
...
export const serviceCards2 = [
  ...
  },
  {
    ...
    // title: "Ui/Ux Design",
    title: "Blockchain and AI Development",
    link: "#",
