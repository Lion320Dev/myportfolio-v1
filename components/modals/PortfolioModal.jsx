            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-content">
                  ...
                  <p className="mb--30">
                    Pump fun project on Ethereum, Base, polygon and BSC.
                    It has featured listing feature, Router selecting feature, Discount feature for token holders, stunning design.
                  </p>
                  <p>
