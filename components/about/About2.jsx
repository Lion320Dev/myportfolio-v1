            ...
            <div className="about-us-left-content-wrap">
              ...
              <div className="design-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-2">
                ...
                <div className="card-info">
                  <h3 className="card-title">Blockchain/AI Development</h3>
            ...
            <div className="about-us-right-content-wrap">
              <div className="section-head text-align-left mb--50">
                ...
                <h2 className="title split-collab tmp-scroll-trigger tmp-fade-in animation-order-2">
                  Boost Business Growth with <br />
                  Smart Blockchain & AI Solutions
                </h2>
                <p className="description tmp-scroll-trigger tmp-fade-in animation-order-3">
                  We provide expert guidance and development in blockchain and AI, helping businesses enhance efficiency, accuracy, and scalability. Our solutions empower organizations to automate processes, strengthen security through decentralization, and unlock new opportunities for innovation and growth.
                </p>
              </div>
              <div className="about-us-section-card row g-5 animation-action-2">
                <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="about-us-card tmponhover single-animation tmp-scroll-trigger tmp-fade-in animation-order-4 active">
                    ...
                    <div className="tmp-light light-top-left" />
                    <p className="card-para">Each one demonstrates my focus on high-quality, scalable blockchain development.</p>
                  </div>
                </div>
                <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                  <div className="about-us-card tmponhover single-animation tmp-scroll-trigger tmp-fade-in animation-order-5">
                    ...
                    <p className="card-para">
                      AI development allows us to provide intelligent and automated solutions for businesses.
                    </p>
                  </div>
                </div>
              </div>
